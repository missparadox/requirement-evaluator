...
Bias the interpretation toward implementation and test readiness. A document with weak business framing can still score as passing if its technical behavior, parameters, edge cases, and verification path are clear enough to implement and test with confidence.

## Default 100-Point Rubric

### OR dimensions: 20 points
